    ...
    <ion-tabs>
      ...
      <ion-tab-bar slot="bottom">
        ...
        <ion-tab-button tab="tab2" href="/tabs/tab2">
          <ion-icon aria-hidden="true" :icon="fileTrayFull" />
          <ion-label>Uitgevoerd</ion-label>
        </ion-tab-button>

        <ion-tab-button tab="tab3" href="/tabs/tab3">
          <ion-icon aria-hidden="true" :icon="book" />
          <ion-label>Knowledgebase</ion-label>
        </ion-tab-button>
...
import { book, fileTrayFull, documentText, settings } from 'ionicons/icons';
